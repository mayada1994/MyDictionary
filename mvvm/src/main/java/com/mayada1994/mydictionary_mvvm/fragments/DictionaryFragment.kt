...
import com.mayada1994.mydictionary_mvvm.adapters.WordsAdapter
import com.mayada1994.mydictionary_mvvm.databinding.DialogAddNewWordBinding
import com.mayada1994.mydictionary_mvvm.databinding.DialogDeleteWordBinding
import com.mayada1994.mydictionary_mvvm.databinding.FragmentDictionaryBinding
...
import com.mayada1994.mydictionary_mvvm.viewmodels.DictionaryViewModel
import java.util.*
...
class DictionaryFragment : Fragment() {
    ...
    private fun initObservers() {
        ...
        viewModel.wordsList.observe(viewLifecycleOwner, { words ->
            setWords(words)
        })

        viewModel.showAddNewWordDialog.observe(viewLifecycleOwner, {
